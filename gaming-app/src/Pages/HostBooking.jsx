...
const HostBooking = () => {
    ...
    useEffect(() => {
        const fetchBookings = async() => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/booking/games-booking/${gameId}`)
    ...
    const deleteBooking = async(id) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL}/api/booking/delete-booking/${id}`)
