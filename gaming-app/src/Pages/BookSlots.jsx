...
const BookSlots = () => {
  ...
  useEffect(() => {
    ...
    const fetchGame = async () => {
      try {
        const res = await axios.get(`http://localhost:5000/api/games/${tournamentId}/${gameId}`)
  ...
  const handleVerifyPayment = async () => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:5000/api/booking/verify-booking', payload)
